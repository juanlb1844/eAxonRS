...
@section('page')
        ...
        <div class="col-lg-12 pd1">
            <h1>Crear ingrediente de platillos</h1>
        </div> 
         
        <div class="col-lg-12 np" data-entity="form-entity" entity-name="ingredients">
            <div class="col-lg-4 col-md-4 col-12 pd1">
                <p>Nombre del ingrediente</p> 
                <input field="data" name-field="name" type-field="input" class="form-control" id="checkin-name" placeholder="nombre del ingrediente" type="text" name=""> 
            </div>
            <div class="col-lg-12 pd1">
