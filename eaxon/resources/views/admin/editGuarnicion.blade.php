...
<style type="text/css">
  ...
  .prev-image {
    ...
    background-image: url('{{$guarnicion->img}}'); 
  }
</style>
...
<div class="col-lg-12 np" data-entity="form-entity" entity-id-field="idguarnicion" entity-name="guarnicion">
    ...
    <div class="col-lg-4 col-md-4 col-xs-12 pd1">
        ...
        <input field="data" name-field="name" type-field="input" class="form-control" id="checkin-name" placeholder="nombre de la guarnición" type="text" name="" value="{{$guarnicion->name}}"> 
        <input field="data" name-field="img" type-field="input" class="form-control" id="img" placeholder="" type="text" name="" value="{{$guarnicion->img}}" style="display: none;"></input> 
    </div>
    <div class="col-lg-4 col-md-4 col-xs-12 pd1">
        <p>Precio</p>
        <input field="data" name-field="price" type-field="input" class="form-control" id="img" placeholder="" type="text" name="" value="{{$guarnicion->price}}">
    </div>
    <div class="col-lg-12 pd1">
        <button class="btn btn-primary" onclick="updateEntity()">guardar</button>
        <button class="btn btn-primary btn-delete" onclick="">borrar</button>
    </div> 
</div>
