...
<style type="text/css">
    ...
    <div class="col-lg-12 col-sm-12"> 
         <div class="col-lg-12 pd1">
            <span class="title-page">PLATILLOS</span>
            <span class="description-page">
                    Crea los productos y configura su comportamiento, asignales ingredientes, guarniciones, menús y sus categorías.
                    <br> También puedes administrarlo desde esta pantalla sin tener que salir.
                </span> 
        ...
        <style type="text/css">
         ...
         <div class="col-lg-9 header-page">
          ...
          <div class="col-lg-3">
            ...
            <div class="panel-control">
                 <a href="{{asset('newDish')}}">
                    <button class="btn btn-primary pull-right create-btn" style="background-image: url('{{asset('/media-admin/plus-2.svg')}}')"> crear nuevo platillo <span class="f-size-4"> +</span></button>
                </a>
            </div>
