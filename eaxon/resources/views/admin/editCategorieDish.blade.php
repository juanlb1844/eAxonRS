...
@section('page')
        ...
        <div class="col-lg-12 pd1">
            <h1>Editar categoría de platillos</h1>
        </div>
        <div class="col-lg-12 np" data-entity="form-entity" entity-id-field="idcategories_menu" entity-name="categories_menu">
            <div class="col-lg-4 col-md-4 col-12 pd1">
                <p>Título</p> 
                <input field="data" name-field="name" type-field="input" class="form-control" id="checkin-name" placeholder="título de categoría" type="text" name="" value="{{$entity->name}}">
            </div>
            <div class="col-lg-12 pd1">
